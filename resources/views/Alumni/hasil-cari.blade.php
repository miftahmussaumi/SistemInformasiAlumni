...
<div class="section-title-bg text-center m-bottom-40">
    <h2 class="wow fadeInDown no-margin" data-wow-duration="1s" data-wow-delay="0.6s"><strong>Hasil Pencarian Alumni</strong></h2>
...
<section class="blog-index">
    ...
    <div class="container clearfix">
        ...
        <div class="row m-bottom-40">
            ...
            <a href="/daftar-alumni"><strong><u> Tampilkan kembali seluruh data</u></strong></a><br>
        </div> <!-- /.row -->
    </div> <!-- /.container -->
